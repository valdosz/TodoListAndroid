package com.mercubuana.uasIlhamRivaldi.adapter;
...
public class itemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.listdata, null);
        ...
        final TextView delImageView = convertView.findViewById(R.id.delete);
